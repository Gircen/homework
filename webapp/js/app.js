...
launch: () => {
    ...
    var grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: 'Месяц выпуска',width:160, dataIndex: 'releaseDateMonth',editor:{xtype: 'combobox',allowBlank: false}},
                { text: 'Рабочий объём двигателя',width:150,     dataIndex: 'engineDisplacement',editor:{xtype: 'numberfield',allowBlank: false} },
                { text: 'Турбонагнетатель',width:120, xtype:'booleancolumn', dataIndex: 'turbocharger',editor:{xtype: 'checkbox',allowBlank: false} },
