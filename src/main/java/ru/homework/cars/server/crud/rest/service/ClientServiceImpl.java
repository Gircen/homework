...
public class ClientServiceImpl implements ClientService {
    private ApplicationContext applicationContext = new AnnotationConfigApplicationContext("ru.homework.cars.server.hibernate");

    @Autowired
    AbstractDAOInterface abstractDAOImpl;
