...
ALTER TABLE characteristics_car
    OWNER TO postgres;
...
CREATE SEQUENCE characteristics_car_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
ALTER TABLE characteristics_car_id_seq
    OWNER TO postgres;
...
ALTER TABLE characteristics_car_links
    OWNER TO postgres;
...
ALTER TABLE characteristics_car_links_id_seq
    OWNER TO postgres;
...
ALTER TABLE transmission_car_id_seq
    OWNER TO postgres;
ALTER SEQUENCE transmission_car_id_seq OWNED BY transmission_car.id;
ALTER TABLE ONLY body_car
    ALTER COLUMN id SET DEFAULT nextval('body_car_id_seq'::regclass);
ALTER TABLE ONLY brand_car
    ALTER COLUMN id SET DEFAULT nextval('brand_car_id_seq'::regclass);
ALTER TABLE ONLY cars
    ALTER COLUMN id SET DEFAULT nextval('cars_id_seq'::regclass);
ALTER TABLE ONLY characteristics_car
    ALTER COLUMN id SET DEFAULT nextval('characteristics_car_id_seq'::regclass);
ALTER TABLE ONLY characteristics_car_links
    ALTER COLUMN id SET DEFAULT nextval('characteristics_car_links_id_seq'::regclass);
ALTER TABLE ONLY colours_car
    ALTER COLUMN id SET DEFAULT nextval('colours_id_seq'::regclass);
ALTER TABLE ONLY drive_car
    ALTER COLUMN id SET DEFAULT nextval('drive_car_id_seq'::regclass);
ALTER TABLE ONLY transmission_car
    ALTER COLUMN id SET DEFAULT nextval('transmission_car_id_seq'::regclass);
...
ALTER TABLE ONLY cars
    ADD CONSTRAINT cars_all_unique_columns_except_id UNIQUE (model, release_date, engine_displacement, turbocharger,
                                                             horsepower, brand_id, transmission_id, drive_id, body_id,
                                                             colour_id);
...
ALTER TABLE ONLY cars
    ADD CONSTRAINT cars_release_date_check_max_min CHECK (to_char(release_date::timestamp with time zone, 'YYYYMM'::text)::integer >=
                                                          198001 AND
                                                          to_char(release_date::timestamp with time zone, 'YYYYMM'::text)::integer <=
                                                          201912);
